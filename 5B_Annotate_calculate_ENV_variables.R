...
finalDf <- readRDS(paste0(cot_path,"DataFinalSummary/FinalDf_perPoint_VedbaGs_filteredSpecies_flappingProbs.rds"))
...
saveRDS(finalDf, paste0(cot_path,"DataFinalSummary/FinalDf_perPoint_VedbaGs_filteredSpecies_flappingProbs_ENV.rds"))
...
saveRDS(finalDf_era5, "DataFinalSummary/FinalDf_perPoint_VedbaGs_filteredSpecies_flappingProbs_ENV.rds")
