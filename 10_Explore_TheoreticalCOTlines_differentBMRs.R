...
gps <- readRDS("finalSummaryDataset_perSegment_fromFix_Aug2024_max10hours.rds") #dataset with one row per segment
radar <- readRDS("RADARdata_finalSummaryDataset_perEcho_COTvariables.rds")
...
saveRDS(speciesSummary_cot, file="speciesSummary_averageBMR_overallCOT_different sources.rds")
